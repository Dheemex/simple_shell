...
/**
 * print_alias - this function add, remove or show aliases
...
/**
 * set_alias - this func add, or override alias
...
int set_alias(char *alias_string, data_of_program *data)
{
	...
	/* Iterates through the alias list coincidence of the varname */
