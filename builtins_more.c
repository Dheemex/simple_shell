...
/**
 * builtin_exit - this function exit of the program with the status
...
/**
 * set_work_directory - this function set the work directory
 * @data: struct for the program's data
...
/**
 * builtin_alias - this function add, remove or show aliases
 * @data: struct for the program's data
 * Return: zero if sucess, or other number if its declared in the arguments
 */
