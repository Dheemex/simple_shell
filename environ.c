 ...
 * @info: Structure containing potential arguments. It is
 ...
 * or also modify an existing one
...
/**
 * _myunsetenv - It removes an environ variable
 * @info: Structure containing potential arguments.
 * It is used to maintain constant function prototype.
 * Return: Always 0
 */
