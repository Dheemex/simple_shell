...
/**
 * interactive - it returns true if the shell is in interactive mode
...
/**
 * is_delim - checks if any of characters is a delimeter
 * @c: the char to the check
 * @delim: the delimeter string value
